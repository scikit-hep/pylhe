...
Historically, one of the first standards for event representation in high-energy physics was the HEPEVT and HEPRUP common blocks [@Boos:2001cv], which provided a Fortran-based structure for storing event information.
