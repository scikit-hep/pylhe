...
date: 14 July 2026 # APN TODO: update date
...
Since `pylhe` version 2.0.0, the library also supports the HDF5-based [@hdf5] LHEH5 format [@Hoche:2019flt;@Bothmann:2023ozs], improving read/write performance and further reducing file sizes for event storage.
